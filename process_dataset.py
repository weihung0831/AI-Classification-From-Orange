...
def load_image(directory, label_num):
    """
    The load_image function loads images from a directory and labels them with the label_num.
    It then returns an array of the image data and an array of the corresponding labels.

    :param directory: Specify the directory where the images are stored
    :param label_num: Assign a label to each image
    :return: A numpy array of the image data and a numpy array of the corresponding labels
    """
